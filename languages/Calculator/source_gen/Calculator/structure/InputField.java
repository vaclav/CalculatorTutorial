...
public class InputField extends BaseConcept implements INamedConcept {
  public static final String concept = "Calculator.structure.InputField";
  ...
  public static InputField newInstance(SModel sm, boolean init) {
    return (InputField) SModelUtil_new.instantiateConceptDeclaration("Calculator.structure.InputField", sm, GlobalScope.getInstance(), init).getAdapter();
  }
