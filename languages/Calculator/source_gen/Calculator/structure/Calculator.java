...
public class Calculator extends BaseConcept implements INamedConcept, IMainClass {
  public static final String concept = "Calculator.structure.Calculator";
  ...
  public static Calculator newInstance(SModel sm, boolean init) {
    return (Calculator) SModelUtil_new.instantiateConceptDeclaration("Calculator.structure.Calculator", sm, GlobalScope.getInstance(), init).getAdapter();
  }
